declare module 'node-irsdk' {
  export interface TelemetryData {
    ...
    PlayerTrackSurface: string | number;
    ...
    CarIdxClassPosition: { [key: number]: number };
    CarIdxClass: { [key: number]: number };
    CarIdxF2Time: { [key: number]: number };
    CarIdxEstTime: { [key: number]: number };
    CarIdxLastLapTime: { [key: number]: number };
    CarIdxBestLapTime: { [key: number]: number };
    CarIdxBestLapNum: { [key: number]: number };
    CarIdxTireCompound: { [key: number]: number };
    CarIdxQualTireCompound: { [key: number]: number };
    CarIdxQualTireCompoundLocked: { [key: number]: boolean };
    CarIdxFastRepairsUsed: { [key: number]: string };
    PaceMode: number;
    CarIdxPaceLine: { [key: number]: number };
    CarIdxPaceRow: { [key: number]: number };
    CarIdxPaceFlags: { [key: number]: number };
    CarIdxSessionFlags: { [key: number]: number };
    OnPitRoad: boolean;
    CarIdxSteer: { [key: number]: number };
    CarIdxRPM: { [key: number]: number };
    CarIdxGear: { [key: number]: number };
    ...
    CarIdxP2P_Status: { [key: number]: boolean };
    CarIdxP2P_Count: { [key: number]: number };
